...
for (int i = 0; i < tam; i++) {
    ...
    Console.Write("Cuantos articulos de estos vas a vener?: "); int articulo = int.Parse(Console.ReadLine());
    Console.Write("Cuanto cuesta cada articulo?: "); int precioart = int.Parse(Console.ReadLine());
